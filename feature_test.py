...
if __name__ == '__main__':
    ...
    save_directory = "feature_test/"
    if not os.path.isdir(save_directory):
        os.mkdir(save_directory[:-1])

    df = pd.read_csv("small_sample_labels.csv")

    images = []
    files = ["W01140 06-13-2014.jpg", "W02120 05-27-2014.jpg", "W03283 04-29-2014.jpg",
             "W03712 06-20-2014.jpg", "W25981 05-22-2014.jpg"]
    image1 = cv2.imread("good_crops/W28932 05-02-2014.jpg")
    #image2 = cv2.imread("good_crops/W02120 05-27-2014.jpg")
    #image3 = cv2.imread("good_crops/W03283 04-29-2014.jpg")
    #image4 = cv2.imread("good_crops/W03712 06-20-2014.jpg")
    #image5 = cv2.imread("good_crops/W25981 05-22-2014.jpg")
